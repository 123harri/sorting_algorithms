 ...
 */
static char get_card_value(deck_node_t *card)
{
 ...
 */
static void insertion_sort_deck_kind(deck_node_t **deck)
{
 ...
 * @deck: A pointer to the head of a deck_node_t doubly-linked list.
 */
static void insertion_sort_deck_value(deck_node_t **deck)
{
	deck_node_t *iter, *insert, *tmp;
